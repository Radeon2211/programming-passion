...
const Footer = () => (
  <div className={classes.Footer}>
    ...
    <div className={classes.Socials}>
      <a href="https://www.linkedin.com/in/rados%C5%82aw-mikrut-a8600b198/" rel="noreferrer" className={classes.Link}>
        <svg className={classes.SocialIcon}>
          <use href={`${sprite}#icon-linkedin`}></use>
        </svg>
      </a>
      <a href="mailto:radoslawmikrut@wp.pl" className={classes.Link}>
        <svg className={classes.SocialIcon}>
