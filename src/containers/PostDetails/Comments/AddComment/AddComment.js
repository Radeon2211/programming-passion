...
const AddComment = (props) => {
  ...
  const onAddComment = (content, postID, postAuthorUID, canWriteComment, resetForm) => (
    dispatch(actions.addComment(content, postID, postAuthorUID, canWriteComment, resetForm))
  );
  ...
  return (
    <Formik
      ...
      onSubmit={(values, { resetForm }) => {
        onAddComment(values.content, props.postID, props.postAuthorUID, canWriteComment, resetForm);
      }}
    >
